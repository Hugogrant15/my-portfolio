...
const TechMarquee = () => {
  const techStack = [
    ...
    "Express",
    "TypeScript",
    "Next.js", // Duplicated for seamless loop
  ];
    ...
    <div className="w-full py-10 overflow-hidden relative">
      ...
      >
        {techStack.map((tech, i) => (
          <div
            key={i}
            className="flex items-center gap-2 text-slate-500 font-mono text-sm font-bold uppercase tracking-widest px-4 border-r border-slate-800 last:border-0"
          >
